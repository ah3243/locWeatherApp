...
function getWeather(city, state){
	...
	var html = '';
	$.ajax({
		url:'http://api.wunderground.com/api/62d0e72f66a7de1a/conditions/q/Germany/'+state+'.json',
		datatype:'jsonp',
...
function getMoreWeather(city, state){
	...
	var html = '';
	$.ajax({
		url:'http://api.wunderground.com/api/8809346183980a69/conditions/q/Germany/'+state+'.json',
		datatype:'jsonp',
		success: function(parsed_json){
			console.log(parsed_json.current_observation);
